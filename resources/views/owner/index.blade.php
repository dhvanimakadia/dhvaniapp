...
<body>
    <div class="container">
        <h1>Owner</h1>
        <form class="example" action="{{ route('owner.index') }}" method="GET">
        ...
        <a href="{{ route('owner.create') }}" class="btn-add-product">Add Owner</a>
        ...
        <table>
            ...
            <tbody>
                @foreach ($owner as $owner)
                    <tr>
                        <td>{{ $owner->name }}</td>
                        <td><img src="{{ asset('images/' . $owner->image) }}" class="product-image" alt="{{ $owner->name }}"></td>
                        <td>{{ $owner->email }}</td>
                        <td>{{ $owner->role }}</td>
                        <td class="action-icons">
                            ...
                            <form action="{{ route('owner.see', $owner->id) }}" method="GET">
                                @csrf
    ...
    <div class="table-footer">
        <a href="{{ route('jwellery.index') }}" class="arrow-link left"><i class="fas fa-chevron-left"></i></a>
        <a href="{{ route('gallery.index') }}" class="arrow-link right"> <i class="fas fa-chevron-right"></i></a>
        </div>
    <script>
