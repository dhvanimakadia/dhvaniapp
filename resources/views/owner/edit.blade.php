    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('owner.update', $owner->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="old_image" value="{{$owner->image}}" id="">
                <input type="file" name="image" class="form-control-file" value="{{$owner->image}}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="role" class="form-control" value="{{ $owner->role }}">
            </div>
